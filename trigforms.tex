...
Let $\Delta=\text{area of the triangle}$, $A,B,C=\text{angles}$,
$a,b,c=\text{sides}$, $s=\text{semiperimeter}=\frac{1}{2}\left(a+b+c\right)$,
$R=\text{circumradius}$, $r=\text{inradius}$, $r_{a},r_{b},r_{c}=\text{radii of excircles}$,
$h_{a},h_{b},h_{c}=\text{perpendiculars}$, $m_{a},m_{b},m_{c}=\text{perpendiculars}$,
$\beta_{a},\beta_{b},\beta_{c}=\text{internal bisectors}$, and $\sigma=\frac{1}{2}\left(m_{a}+m_{b}+m_{c}\right)$.
Then:

\begin{eqnarray*}
\Delta & = & \frac{1}{2}\left(\text{base}\cdot\text{height}\right)\\
 & = & \sqrt{s\left(s-a\right)\left(s-b\right)\left(s-c\right)}\\
 & = & \frac{abc}{4R}\\
 & = & \sqrt{rr_{a}r_{b}r_{c}}\\
 & = & \frac{1}{2}\sqrt[3]{abch_{a}h_{b}h_{c}}\\
 & =\\
 & =\\
 & =\\
 & =
