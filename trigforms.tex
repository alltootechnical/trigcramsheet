...
\rhead{\textsf{alltootechnical.tk}}
...
\definecolor{ffvvqq}{rgb}{0.44313725490196076,0.44313725490196076,0.44313725490196076} \definecolor{qqqqff}{rgb}{0.3333333333333333,0.3333333333333333,0.3333333333333333} \definecolor{ccqqqq}{rgb}{0.26666666666666666,0.26666666666666666,0.26666666666666666} \definecolor{qqwuqq}{rgb}{0.12941176470588237,0.12941176470588237,0.12941176470588237} 


\subsection{$y=\sin x$}

\begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm] \draw[->,color=black] (-3.14,0) -- (3.14,0); \foreach \x in {-3,-2,-1,1,2,3} \draw[shift={(\x,0)},color=black] (0pt,2pt) -- (0pt,-2pt) node[below] {\footnotesize $\x$}; \draw[->,color=black] (0,-2) -- (0,2); \foreach \y in {-2,-1,1} \draw[shift={(0,\y)},color=black] (2pt,0pt) -- (-2pt,0pt) node[left] {\footnotesize $\y$}; \draw[color=black] (0pt,-10pt) node[right] {\footnotesize $0$}; \clip(-3.14,-2) rectangle (3.14,2); \draw[line width=1.2pt,color=qqwuqq,smooth,samples=100,domain=-3.14:3.14] plot(\x,{sin(((\x))*180/pi)}); \begin{scriptsize} \draw[color=qqwuqq] (-5.48,0.54) node {$y=\sin$}; \end{scriptsize} \end{tikzpicture}


\subsection{$y=\cos x$}

\begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm] \draw[->,color=black] (-3.14,0) -- (3.14,0); \foreach \x in {-3,-2,-1,1,2,3} \draw[shift={(\x,0)},color=black] (0pt,2pt) -- (0pt,-2pt) node[below] {\footnotesize $\x$}; \draw[->,color=black] (0,-2) -- (0,2); \foreach \y in {-2,-1,1} \draw[shift={(0,\y)},color=black] (2pt,0pt) -- (-2pt,0pt) node[left] {\footnotesize $\y$}; \draw[color=black] (0pt,-10pt) node[right] {\footnotesize $0$}; \clip(-3.14,-2) rectangle (3.14,2); \draw[line width=1.2pt,color=qqwuqq,smooth,samples=100,domain=-3.14:3.14] plot(\x,{cos(((\x))*180/pi)}); \begin{scriptsize} \draw[color=qqwuqq] (-5.48,0.54) node {$y=\sin$}; \end{scriptsize} \end{tikzpicture}


\subsection{$y=\tan x$}

\begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm] \draw[->,color=black] (-3.14,0) -- (3.14,0); \foreach \x in {-3,-2,-1,1,2,3} \draw[shift={(\x,0)},color=black] (0pt,2pt) -- (0pt,-2pt) node[below] {\footnotesize $\x$}; \draw[->,color=black] (0,-2) -- (0,2); \foreach \y in {-2,-1,1} \draw[shift={(0,\y)},color=black] (2pt,0pt) -- (-2pt,0pt) node[left] {\footnotesize $\y$}; \draw[color=black] (0pt,-10pt) node[right] {\footnotesize $0$}; \clip(-3.14,-2) rectangle (3.14,2); \draw[line width=1.2pt,color=qqwuqq,smooth,samples=100,domain=-3.14:3.14] plot(\x,{tan(((\x))*180/pi)}); \begin{scriptsize} \draw[color=qqwuqq] (-5.48,0.54) node {$y=\sin$}; \end{scriptsize} \end{tikzpicture}
...
\noindent \begin{center}
${\displaystyle \frac{\cot(\alpha/2)}{s-a}=\frac{\cot(\beta/2)}{s-b}=\frac{\cot(\gamma/2)}{s-c}=\frac{1}{r}}$
\par\end{center}
...
\hline 
\hline 
 & \input{ssa3.tikz} & \input{ssa2.tikz} & \input{ssa1.tikz}\tabularnewline
\hline 
...
\section{Identities without Variables}
\begin{lyxlist}{00.00.0000}
