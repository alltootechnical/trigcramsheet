...
\noindent \begin{center}
\begin{tikzpicture} \begin{polaraxis}[my style polar] \addplot[color=blue,domain=0:360, samples=200]{2*cos(4*x)}; \end{polaraxis} \end{tikzpicture}
\par\end{center}
...
\noindent \begin{center}
\begin{tikzpicture} \begin{polaraxis}[my style polar] \addplot[color=blue,domain=0:90, samples=100]{4*sqrt(sin(2*x))}; \addplot[color=blue,domain=180:270, samples=100]{4*sqrt(sin(2*x))}; \end{polaraxis} \end{tikzpicture}
\par\end{center}
