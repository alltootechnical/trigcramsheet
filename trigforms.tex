...
Then there are $n$ sections if $n$ is odd (blue), or $2n$ sections
if $n$ is even (red). A slightly more symmetric version considers
instead $r=a\left|\sec\left(n\theta\right)\right|$.

\noindent \begin{center}
\begin{tikzpicture} \begin{polaraxis}[my style polar] \addplot[color=blue,domain=    0: 29-3, samples=100]{3/2*sec(3*x)}; \addplot[color=blue,domain=	31+3: 89-3, samples=100]{3/2*sec(3*x)}; \addplot[color=blue,domain= 91+3:149-3, samples=100]{3/2*sec(3*x)}; \addplot[color=blue,domain=151+3:209-3, samples=100]{3/2*sec(3*x)}; \addplot[color=blue,domain=211+3:269-3, samples=100]{3/2*sec(3*x)}; \addplot[color=blue,domain=271+3:329-3, samples=100]{3/2*sec(3*x)}; \addplot[color=red,domain=    0: 45-4, samples=100]{sec(2*x)}; \addplot[color=red,domain= 45+4:135-4, samples=100]{sec(2*x)}; \addplot[color=red,domain=135+4:225-4, samples=100]{sec(2*x)}; \addplot[color=red,domain=225+4:315-4, samples=100]{sec(2*x)}; \addplot[color=red,domain=315+4:360  , samples=100]{sec(2*x)}; \end{polaraxis} \end{tikzpicture}
\par\end{center}
